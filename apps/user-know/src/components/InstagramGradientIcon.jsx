...
/** Instagram glyph (Nucleo path) with official-style gradient; not achievable via currentColor alone. */
const PATH_D =
...
export default function InstagramGradientIcon({ size = 16, className }) {
