...
export default function App() {
  ...
  const sparksPopoverRef = useRef(null)
  ...
  // Standalone popovers: ensure click-outside + Escape always closes.
  // (We mount Popover without MenuTrigger, so we handle dismissal explicitly.)
  useEffect(() => {
    if (!anchorsReady) return
    if (!helpMenuOpen && !sparksMenuOpen && !accountMenuOpen) return

    function isIn(ref, target) {
    ...
    function onPointerDown(e) {
      ...
      if (helpMenuOpen && !isIn(helpPopoverRef, t) && !isIn(helpTriggerRef, t)) {
        setHelpMenuOpen(false)
      }
      if (sparksMenuOpen && !isIn(sparksPopoverRef, t) && !isIn(sparksTriggerRef, t)) {
        setSparksMenuOpen(false)
      }
      if (accountMenuOpen && !isIn(accountPopoverRef, t) && !isIn(accountTriggerRef, t)) {
        setAccountMenuOpen(false)
      }
    }
  ...
  }, [anchorsReady, helpMenuOpen, sparksMenuOpen, accountMenuOpen])
  ...
  return (
    <div className="app-shell">
      ...
      <main className="page page--discovery" role="main">
          ...
          <div className="discovery-top__text">
            <div className="discovery-title-row">
              ...
              <TitanTooltip
                placement="bottom"
                content={
                  <div className="discovery-info-tooltip">
                    <div className="discovery-info-tooltip__title">New Creator Discovery</div>
                    <div className="discovery-info-tooltip__body">
              ...
              >
                <TitanIconButton
                  ...
                  className="discovery-info"
                  aria-label="About Creator Discovery"
                  onPress={() => {}}
                >
